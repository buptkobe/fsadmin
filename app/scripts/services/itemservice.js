...
services.factory('ItemFactory', function($resource) {
    return $resource(baseURL + 'pt/service', {
        formid: 'common_fit_item',
        pt_charset: 'utf-8'
    }, {
        query: {
            method: 'GET',
            params: {
                pt_control_action: 'list'
            },
            isArray: true
        },
        create: {
...
services.factory('ActivityFactory', function($resource) {
    return $resource(baseURL + 'pt/service', {
        ...
        currentbyapply: {
            method: 'GET',
            params: {
                pt_control_action: 'currentbyapply'
            },
            isArray: true
        }
    })
...
services.factory('ShareFactory', function($resource) {
    return $resource(baseURL + 'pt/service', {
        formid: 'common_fit_share',
        pt_charset: 'utf-8'
    }, {
        query: {
            method: 'GET',
            params: {
                pt_control_action: 'config'
            }
        }
    })
});
...
services.factory('ExamQuestionFactory', function($resource) {
    return $resource(baseURL + 'pt/service', {
        formid: 'common_fit_examquestion',
        pt_charset: 'utf-8'
    }, {
        query: {
            method: 'GET',
